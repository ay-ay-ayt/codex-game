...
function createFighter(color, isPlayer = false) {
  ...
  const darkMat = new THREE.MeshStandardMaterial({ color: 0x1f2d3b, roughness: 0.54, metalness: 0.34 });
  const panelMat = new THREE.MeshStandardMaterial({
    color: isPlayer ? 0x77cfff : 0xf0b85e,
    roughness: 0.32,
    metalness: 0.74,
    emissive: isPlayer ? 0x0d1f33 : 0x261607,
    emissiveIntensity: isPlayer ? 0.28 : 0.2,
  });

  const fuselage = new THREE.Mesh(new THREE.CylinderGeometry(2.05, 2.75, 38, 20), bodyMat);
  fuselage.rotation.z = -Math.PI * 0.5;

  const nose = new THREE.Mesh(new THREE.ConeGeometry(1.55, 15.5, 20), trimMat);
  nose.rotation.z = -Math.PI * 0.5;
  nose.position.x = 26.8;

  const tailCone = new THREE.Mesh(new THREE.ConeGeometry(1.65, 10.2, 16), darkMat);
  tailCone.rotation.z = Math.PI * 0.5;
  tailCone.position.x = -24.2;
  ...
  cockpit.scale.set(2.45, 0.72, 0.76);
  cockpit.position.set(8.9, 2.55, 0);

  const enginePodL = new THREE.Mesh(new THREE.CylinderGeometry(1.75, 2.15, 16.5, 16), bodyMat);
  enginePodL.rotation.z = -Math.PI * 0.5;
  enginePodL.position.set(-9.9, 2.75, 2.95);
  const enginePodR = new THREE.Mesh(new THREE.CylinderGeometry(1.75, 2.15, 16.5, 16), bodyMat);
  enginePodR.rotation.z = -Math.PI * 0.5;
  enginePodR.position.set(-9.9, 2.75, -2.95);
  ...
  addPaired(() => new THREE.Mesh(new THREE.BoxGeometry(24.2, 0.42, 6.8), trimMat), 7.9, 0.4, -0.95, -2.2);
  addPaired(() => new THREE.Mesh(new THREE.BoxGeometry(10.8, 0.34, 1.9), trimMat), 12.8, 0.56, -0.95, 8.5);
  addPaired(() => new THREE.Mesh(new THREE.BoxGeometry(6.2, 0.24, 1.25), trimMat), 3.9, 0.38, 0.38, 13.0);

  const finL = new THREE.Mesh(new THREE.BoxGeometry(0.16, 10.8, 0.95), bodyMat);
  finL.position.set(-13.4, 8.35, 3.05);
  finL.rotation.set(0, 0.16, -0.1);
  const finR = new THREE.Mesh(new THREE.BoxGeometry(0.16, 10.8, 0.95), bodyMat);
  finR.position.set(-13.4, 8.35, -3.05);
  finR.rotation.set(0, -0.16, 0.1);

  const intakeL = new THREE.Mesh(new THREE.BoxGeometry(5.4, 1.5, 1.2), darkMat);
  intakeL.position.set(11.2, 0.15, 3.1);
  const intakeR = new THREE.Mesh(new THREE.BoxGeometry(5.4, 1.5, 1.2), darkMat);
  intakeR.position.set(11.2, 0.15, -3.1);


  const spine = new THREE.Mesh(new THREE.BoxGeometry(13.5, 0.85, 1.55), panelMat);
  spine.position.set(1.8, 3.15, 0);
  spine.rotation.z = -0.07;

  const wingRootL = new THREE.Mesh(new THREE.BoxGeometry(11.8, 0.34, 2.0), panelMat);
  wingRootL.position.set(-2.6, -0.15, 4.9);
  wingRootL.rotation.y = 0.44;
  const wingRootR = wingRootL.clone();
  wingRootR.position.z = -4.9;
  wingRootR.rotation.y = -0.38;

  const tailplaneL = new THREE.Mesh(new THREE.BoxGeometry(6.8, 0.24, 1.5), panelMat);
  tailplaneL.position.set(-17.4, 3.2, 4.4);
  tailplaneL.rotation.y = 0.52;
  tailplaneL.rotation.x = -0.06;
  const tailplaneR = tailplaneL.clone();
  tailplaneR.position.z = -4.2;
  tailplaneR.rotation.y = -0.45;
  tailplaneR.rotation.x = 0.08;

  const pitot = new THREE.Mesh(new THREE.CylinderGeometry(0.08, 0.12, 3.4, 8), trimMat);
  pitot.rotation.z = -Math.PI * 0.5;
  pitot.position.set(32.2, 0.28, 0);

  const panelStripe = new THREE.Mesh(new THREE.BoxGeometry(18.2, 0.16, 0.72), panelMat);
  panelStripe.position.set(1.1, -0.08, 0);

  const exhaustL = new THREE.Mesh(new THREE.CylinderGeometry(1.05, 1.48, 3.7, 12), darkMat);
  exhaustL.rotation.z = Math.PI * 0.5;
  exhaustL.position.set(-24.0, 2.0, 2.95);
  const exhaustR = new THREE.Mesh(new THREE.CylinderGeometry(1.05, 1.48, 3.7, 12), darkMat);
  exhaustR.rotation.z = Math.PI * 0.5;
  exhaustR.position.set(-24.0, 2.0, -2.95);
