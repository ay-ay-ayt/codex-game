...
function createFighter(color, isPlayer = false) {
  ...
  const wingL = new THREE.Mesh(buildSurface([
    [12.0, 2.8],
    [7.3, 11.5],
    [-7.0, 15.4],
    [-20.0, 17.2],
  ...
  wingL.position.set(0.25, -1.02, 0);
  wingL.rotation.x = -0.05;
  const wingR = wingL.clone();
  wingR.scale.z = -1;

  const flapL = new THREE.Mesh(buildSurface([
    [-8.7, 9.7],
    [-14.8, 14.2],
    [-18.7, 15.4],
    [-17.2, 11.7],
