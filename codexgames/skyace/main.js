...
function createFighter(color, isPlayer = false) {
  ...
  cockpitBody.scale.set(0.78, 0.14, 0.16);
  cockpitBody.position.set(7.0, 0.78, 0);
  ...
  cockpitGlass.scale.set(1.2, 0.64, 0.5);
  cockpitGlass.position.set(7.2, 1.3, 0);
