...
function createFighter(color, isPlayer = false) {
  ...
  const canopyBase = new THREE.Mesh(new THREE.CylinderGeometry(1.05, 1.18, 10.8, 20), bodyMat);
  canopyBase.rotation.z = -Math.PI * 0.5;
  canopyBase.position.set(5.9, 1.08, 0);
  const canopy = new THREE.Mesh(
    new THREE.CapsuleGeometry(1.15, 6.0, 7, 16),
  ...
  canopy.scale.set(1.52, 0.58, 0.68);
  canopy.position.set(5.7, 1.36, 0);
