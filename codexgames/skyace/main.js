...
function createFighter(color, isPlayer = false) {
  ...
  const engineL = new THREE.Mesh(new THREE.CylinderGeometry(1.55, 1.98, 17.6, 18), bodyMat);
  engineL.rotation.z = -Math.PI * 0.5;
  engineL.position.set(-9.5, 2.2, 3.15);
  const engineR = engineL.clone();
  engineR.position.z = -3.15;

  const nozzleL = new THREE.Mesh(new THREE.CylinderGeometry(1.05, 1.55, 4.2, 18), darkMat);
  ...
  const burnerL = new THREE.Mesh(new THREE.CylinderGeometry(0.62, 0.82, 1.5, 16), burnerCoreMat);
  ...
  const flameOuterL = new THREE.Mesh(new THREE.ConeGeometry(0.62, 5.8, 18), flameOuterMat);
  ...
  const flameInnerL = new THREE.Mesh(new THREE.ConeGeometry(0.34, 4.2, 16), flameInnerMat);
  ...
  const flameCore = new THREE.Mesh(new THREE.CylinderGeometry(0.14, 0.2, 2.9, 14), flameCoreMat);
  flameCore.rotation.z = Math.PI * 0.5;
  flameCore.position.set(-27.3, 1.35, 0);
  ...
  const glow = new THREE.Mesh(
    new THREE.CylinderGeometry(0.45, 0.72, 1.8, 14),
  ...
  glow.position.set(-26.55, 1.35, 0);
...
function updatePlaneExhaust(plane, boostLevel = 0) {
  ...
  if (plane.exhaust.core) {
    plane.exhaust.core.scale.set(1 + boostLevel * 0.28, 1 + boostLevel * 1.9, 1 + boostLevel * 0.28);
    plane.exhaust.core.material.opacity = clamp(0.84 + boostLevel * 0.14, 0.5, 0.99);
  }

  const glow = plane.exhaust.glow;
  glow.scale.set(1 + boostLevel * 0.6, 1 + boostLevel * 1.1, 1 + boostLevel * 0.6);
  glow.material.opacity = clamp(0.68 + boostLevel * 0.26, 0.45, 0.99);
}
