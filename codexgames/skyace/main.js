...
function createFighter(color, isPlayer = false) {
  ...
  cockpitBody.position.set(3.9, 1.56, 0);
  ...
  cockpitFairing.position.set(6.2, 1.34, 0);
  ...
  cockpitGlass.scale.set(2.93, 1.67, 1.2);
  cockpitGlass.position.set(3.9, 3.1, 0);
